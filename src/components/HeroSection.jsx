...
const HeroSection = ({ textColor, textColor2, darkMode }) => {
  return (
    <div id="home" className="flex gap-[20px] justify-between max-md:justify-center max-md:flex-col-reverse max-md:h-[100vh] items-center w-full max-sm:px-[20px] sm:px-[40px] md:px-[60px] lg:px-[100px] transition-all ease-in-out duration-300">
      {/* Text Section */}
      <div className="max-md:w-[100%] md:w-[50%] h-[450px] max-sm:h-[370px] flex flex-col justify-between gap-2 ">
        ...
        <div id="SOCIAL-MEDIA" className={`flex flex-col gap-[20px]`}>
      ...
      {/* Image Section */}
      <div className="w-[60%] max-lg:w-[70%] lg:w-[50%] xl:w-[40%] max-md:w-[80%] relative flex justify-center rounded-3xl transition-all ease-in-out duration-700">
